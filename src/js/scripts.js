(function($) {
  ...
  Drupal.behaviors.dtagovauAddWidthIndicator = {
    // Adds a class to the <body> tag to indicate browser width.
    attach: function(context, settings) {
      function getWidth() {
        ...
        if (pixels <= 576) {
          ...
          return 'mobile';
        } else if (pixels > 576 && pixels <= 768) {
          AU.accordion.Close( $( '.js-au-accordion-wrapper' ).children('.js-au-accordion')[ 0 ], 50);
          return 'xs';
        } else if (pixels > 768 && pixels <= 977) {
          AU.accordion.Close( $( '.js-au-accordion-wrapper' ).children('.js-au-accordion')[ 0 ], 50);
          return 'sm';
        } else if (pixels > 977 && pixels <= 1200) {
          AU.accordion.Open( $( '.js-au-accordion-wrapper' ).children('.js-au-accordion')[ 0 ], 50);
          return 'md';
        } else if (pixels > 1200) {
          return 'lg';
        } else {
      ...
      $('body').attr('class', getWidth() + ' au-grid');
